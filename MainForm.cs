            ...
            Task.Run(() =>
            {
                ...
                try
                {
                    ...
                    while (onlinePlayer.Connected)
                    {
                        ...
                        switch (command)
                        {
                            case Command.GetWithBot:
                                onlinePlayer.Client.SendInt(withBot ? 1 : 0);
                                break;
                            ...
                            case Command.SetResult:
                                {
                                    ...
                                    Invoke(new Action(() =>
                                    {
                                        ...
                                        explosion.Bounds = new RectangleF(loser.DrawBounds.Left - 10,
                                            loser.DrawBounds.Top - 10, loser.DrawBounds.Width + 20,
                                            loser.DrawBounds.Height + 20);
                                        explosion.Play();
                                        Task.Run(() =>
                                        {
                                            for (int i = 0; i < 100; i++)
